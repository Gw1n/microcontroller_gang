...
{
    /* Setup */
    EIMSK |= ((1 << INT1) | (1 << INT0));          // Enable ext. INT1 and INT0
    EICRA = ((1 << ISC11) | (1 << ISC01));          // External interrupt on falling edge

    sei();                         // enable interrupts

    DDRB |= (LED13 | LED6 | LED7);                 // set PB5 to output
    PORTD |= (SWITCH1 | SWITCH2);              // set pull-up at PD3 and PD2
    DDRD |= (LED1 | LED2 | LED4 | LED5);         // set pins for LED1, LED2 to output pins
